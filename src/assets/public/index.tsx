...
export const fav_icon = 'babyshower/assets/logo/moji_m.png'

export const moji_loaders = [
    {
        name: 'Moji loader 1',
        src: '/babyshower/assets/mojis/loader/moji_loader1.png'
    },
    {
        name: 'Moji loader 2',
        src: '/babyshower/assets/mojis/loader/moji_loader2.png'
    },
    {
        name: 'Moji loader 3',
        src: '/babyshower/assets/mojis/loader/moji_loader3.png'
    }
]
...
export const moji_selfies = [
    {
        name: 'Moji cheese',
        src: '/babyshower/assets/mojis/selfie/cns.png'
    },
]

export const moji_err = {
    404: '/babyshower/assets/mojis/error/404.png',
    err: '/babyshower/assets/mojis/error/moji_err.png'
}